...
function CustomerAnalytics() {
  ...
  const fetchDashboard = async () => {
    try {
      setLoading(true);
      const response = await api.get('/reports/loyalty/dashboard/');
  ...
  const fetchCustomerList = async () => {
    try {
      ...
      const response = await api.get(`/reports/loyalty/customers/?${params}`);
  ...
  const fetchRepeatData = async () => {
    try {
      setLoading(true);
      const response = await api.get('/reports/loyalty/repeat/');
  ...
  const fetchFrequencyData = async () => {
    try {
      setLoading(true);
      const response = await api.get('/reports/loyalty/frequency/');
  ...
  const fetchRecencyData = async () => {
    try {
      setLoading(true);
      const response = await api.get('/reports/loyalty/recency/');
  ...
  const fetchLtvData = async () => {
    try {
      setLoading(true);
      const response = await api.get('/reports/loyalty/ltv/');
  ...
  const fetchCohortData = async () => {
    try {
      setLoading(true);
      const response = await api.get('/reports/loyalty/cohorts/');
